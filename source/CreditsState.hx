...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Vs. Foxa & Plankton Team'],
			['Charles',		        'charlescat',		    'Programmer of the Mod',						'https://gamejolt.com/@CharlesCat',	'444444'],
			['COOLDUDE2009',			'joer',		'Artist/Animator/Composer of Plankton Week',					'https://gamejolt.com/@joerontheblower',		'C30085'],
			...
			['Beta testers',			'the fans',			'All those beta testers out there',				'https://discord.gg/PsDYjdKjEa',			'389A58'],
