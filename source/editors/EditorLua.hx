...
class EditorLua {
	...
	public function new(script:String) {
		...
		if(resultStr != null && result != 0) {
			lime.app.Application.current.window.alert(resultStr, 'lua script has error, i am 20 feet from your home, and approaching rapidly. now START RUNNING.');
			trace('no, error got like ' + resultStr);
			lua = null;
			return;
		}
