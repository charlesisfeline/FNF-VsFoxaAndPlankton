...
sadfasd = 0
function onCreate()
    makeLuaText("tnh", 'Note Arrow Score Combos: 0', 250, 21, 259);
    makeLuaText("cm", 'Note Arrow Score Combos: 0', 200, 17, 302);
...
function goodNoteHit(id, direction, noteType, isSustainNote)
    ...
    setTextString('tnh', 'Total Note Hits: ' .. tostring(notehitlol))
